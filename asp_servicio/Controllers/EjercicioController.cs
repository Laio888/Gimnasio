...
namespace asp_servicio.Controllers
{
    ...
    {
        private IEjercicioAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public EjercicioController(IEjercicioAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorNombre()
        {
            ...
            {
                var datos = ObtenerDatos();
                var entidad = JsonConversor.ConvertirAObjeto<Ejercicio>(
