...
namespace asp_servicio.Controllers
{
    ...
    {
        private ICoachAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public CoachController(ICoachAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorNombre()
        {
            ...
            {
                var datos = ObtenerDatos();
                var entidad = JsonConversor.ConvertirAObjeto<Coach>(
        ...
        public string Login()
        {
            ...
            try
            {
                ...
                // Validar por correo
                var coach = this.iAplicacion!.Login(entidad.Correo);
                ...
                {
                    // Generar token con TokenAplicacion
                    var token = iAplicacionToken!.Generar(coach);

                    respuesta["Respuesta"] = "OK";
                    respuesta["Coach"] = coach;
