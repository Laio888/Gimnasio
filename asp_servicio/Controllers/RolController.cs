...
namespace asp_servicio.Controllers
{
    ...
    {
        private IRolAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public RolController(IRolAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorNombre()
        {
            ...
            {
                var datos = ObtenerDatos();
                var entidad = JsonConversor.ConvertirAObjeto<Rol>(
