...
namespace asp_servicio.Controllers
{
    ...
    {
        private IMensajeAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public MensajeController(IMensajeAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorNombre()
        {
            ...
            {
                var datos = ObtenerDatos();
                var entidad = JsonConversor.ConvertirAObjeto<Mensaje>(
