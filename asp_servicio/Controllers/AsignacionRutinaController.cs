...
namespace asp_servicio.Controllers
{
    ...
    {
        private IAsignacionRutinaAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public AsignacionRutinaController(IAsignacionRutinaAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorNombre()
        {
            ...
            {
                var datos = ObtenerDatos();
                var entidad = JsonConversor.ConvertirAObjeto<AsignacionRutina>(
