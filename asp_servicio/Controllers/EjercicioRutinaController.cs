...
namespace asp_servicio.Controllers
{
    ...
    {
        private IEjercicioRutinaAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public EjercicioRutinaController(IEjercicioRutinaAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorNombre()
        {
            ...
            {
                var datos = ObtenerDatos();
                var entidad = JsonConversor.ConvertirAObjeto<EjercicioRutina>(
