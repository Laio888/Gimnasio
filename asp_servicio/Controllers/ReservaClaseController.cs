...
namespace asp_servicio.Controllers
{
    ...
    {
        private IReservaClaseAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public ReservaClaseController(IReservaClaseAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorNombre()
        {
            ...
            {
                var datos = ObtenerDatos();
                var entidad = JsonConversor.ConvertirAObjeto<ReservaClase>(
