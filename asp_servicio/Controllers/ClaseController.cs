...
namespace asp_servicio.Controllers
{
    ...
    {
        private IClaseAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public ClaseController(IClaseAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorNombre()
        {
            ...
            {
                var datos = ObtenerDatos();
                var entidad = JsonConversor.ConvertirAObjeto<Clase>(
