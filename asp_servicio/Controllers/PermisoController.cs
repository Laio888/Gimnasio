...
namespace asp_servicio.Controllers
{
    ...
    {
        private IPermisoAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public PermisoController(IPermisoAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorNombre()
        {
            ...
            {
                var datos = ObtenerDatos();
                var entidad = JsonConversor.ConvertirAObjeto<Permiso>(
