...
namespace asp_servicio.Controllers
{
    ...
    {
        private IPagoAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public PagoController(IPagoAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorNombre()
        {
            ...
            {
                var datos = ObtenerDatos();
                var entidad = JsonConversor.ConvertirAObjeto<Pago>(
