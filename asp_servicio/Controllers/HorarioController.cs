...
namespace asp_servicio.Controllers
{
    ...
    {
        private IHorarioAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public HorarioController(IHorarioAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorNombre()
        {
            ...
            {
                var datos = ObtenerDatos();
                var entidad = JsonConversor.ConvertirAObjeto<Horario>(
