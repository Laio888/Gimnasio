...
namespace asp_servicio.Controllers
{
    ...
    {
        private IRutinaAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public RutinaController(IRutinaAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorNombre()
        {
            ...
            {
                var datos = ObtenerDatos();
                var entidad = JsonConversor.ConvertirAObjeto<Rutina>(
