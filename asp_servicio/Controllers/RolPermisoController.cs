...
namespace asp_servicio.Controllers
{
    ...
    {
        private IRolPermisoAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public RolPermisoController(IRolPermisoAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorNombre()
        {
            ...
            {
                var datos = ObtenerDatos();
                var entidad = JsonConversor.ConvertirAObjeto<RolPermiso>(
